...
export function Guide() {
    return (<div className="mainContent about">
        ...
        <p><b>wherewords.id</b> splits the world into approximately 105
            trillion 2m x 2m squares and gives them each a four word name - the location's
            'wherewords'.</p>
        ...
        <p>Encoding data of any sort into words is trivial, and there are other similar
            systems out there that work generically or specifically on locations.  For more details
            on how wherewords does it, see <Link to="/+about">why?</Link>.</p>
